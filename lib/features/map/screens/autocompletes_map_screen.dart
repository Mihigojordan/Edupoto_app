...
class AutoCompleteDeliveryMapScreen extends StatefulWidget {
  const AutoCompleteDeliveryMapScreen({
    super.key,
...
class _DeliveryMapScreenState extends State<AutoCompleteDeliveryMapScreen> {
...
Positioned(
  ...
  onTap: (latLng) {
    // When user taps, move camera to that position
