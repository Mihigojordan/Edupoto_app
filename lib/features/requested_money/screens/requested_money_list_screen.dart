...
import 'package:hosomobile/features/requested_money/widgets/requested_money_screen.dart';
...
class RequestedMoneyListScreen extends StatefulWidget {
  ...
  const RequestedMoneyListScreen({super.key, required this.requestType});
