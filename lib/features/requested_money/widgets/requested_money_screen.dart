...
import 'package:hosomobile/features/requested_money/widgets/requested_money_card.dart';

class RequestedMoneyScreen extends StatefulWidget {
  final ScrollController? scrollController;
  final bool? isHome;
  final RequestType? requestType;
  const RequestedMoneyScreen({super.key, this.scrollController, this.isHome, this.requestType,});
...
class RequestedMoneyShimmer extends StatelessWidget {
  final bool? isHome;
  const RequestedMoneyShimmer({super.key, this.isHome});
  @override
  Widget build(BuildContext context) {
