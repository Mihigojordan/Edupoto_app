...
import 'package:hosomobile/features/setting/domain/models/requested_money_model.dart';
import 'package:hosomobile/features/requested_money/domain/models/withdraw_histroy_model.dart';
import 'package:hosomobile/helper/custom_snackbar_helper.dart';
import 'package:hosomobile/helper/date_converter_helper.dart';
...
import 'package:hosomobile/features/requested_money/screens/requested_money_list_screen.dart';
...
class RequestedMoneyCard extends StatefulWidget {
  ...
  const RequestedMoneyCard({super.key, this.requestedMoney, this.isHome, this.requestType, this.withdrawHistory, this.itemList});
...
class MethodFieldView extends StatelessWidget {
  final String type;
  final String value;
  const MethodFieldView({super.key, required this.type, required this.value});
