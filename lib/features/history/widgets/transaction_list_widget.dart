...
import 'package:hosomobile/features/history/widgets/history_shimmer_widget.dart';
...
class TransactionListWidget extends StatelessWidget {
  ...
  final bool? isHome;
  final String? type;
  const TransactionListWidget({super.key, this.scrollController, this.isHome, this.type});
