...
import 'package:hosomobile/features/transaction_money/widgets/contact_list_widget.dart';
                          ...
                          SizedBox(height: 80.0,
                            child: ListView.builder(itemCount: contactController.sendMoneySuggestList.length, scrollDirection: Axis.horizontal,
                                itemBuilder: (context, index)=> CustomInkWellWidget(
                                  ...
                                  onTap: (){
                               Get.to( TerekaAsome(transactionType: widget.transactionType,
                                            contactModel: ContactModel(
                                                phoneNumber: contactController.sendMoneySuggestList[index].phoneNumber,
                                                name:  contactController.sendMoneySuggestList[index].name ,
                                                avatarImage: "$customerImageBaseUrl/${contactController.sendMoneySuggestList[index].avatarImage.toString()}"),
                          ...
                          SizedBox(height: 80.0,
                            child: ListView.builder(itemCount: contactController.requestMoneySuggestList.length, scrollDirection: Axis.horizontal,
                                itemBuilder: (context, index)=> CustomInkWellWidget(
                                  ...
                                  highlightColor: Theme.of(context).textTheme.titleLarge!.color!.withOpacity(0.3),
                                  onTap: (){
                             contactController.onTapSuggest(index, widget.transactionType);
                                  }    
                                                ,
                                  child: Container(
                                    margin: const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
