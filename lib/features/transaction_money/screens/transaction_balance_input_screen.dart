...
import 'package:hosomobile/features/add_money/widgets/digital_payment_widget.dart';
import 'package:hosomobile/features/transaction_money/screens/transaction_confirmation_screen.dart';
import 'package:hosomobile/features/transaction_money/widgets/input_box_widget.dart';
import 'package:hosomobile/features/transaction_money/widgets/purpose_widget.dart';
...
class TransactionBalanceInputScreen extends StatefulWidget {
  ...
  final List<EduboxMaterialModel>? dataList;
   const TransactionBalanceInputScreen({super.key, this.transactionType ,this.contactModel, this.dataList, this.countryCode});
  @override
