...
import 'package:hosomobile/features/transaction_money/domain/models/hex_color_model.dart';
...
class _PurposeItem extends StatelessWidget {
  const _PurposeItem({super.key, required this.image, required this.title, required this.color,required this.onTap});
  final String? image;
  final String? title;
  final Color color;
