...
import 'package:hosomobile/features/transaction_money/widgets/contact_item_widget.dart';

class ContactListWidget extends StatelessWidget{
  final String? transactionType;
  const ContactListWidget({ super.key, this.transactionType});
...
class _ContactShimmer extends StatelessWidget {
  const _ContactShimmer({super.key});
