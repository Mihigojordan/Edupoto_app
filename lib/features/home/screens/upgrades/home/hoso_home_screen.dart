...
await Get.find<AnnouncementController>().getAnnouncementList(reload).then((_) {
   announcenents =Get.find<AnnouncementController>().announcementList;
});
await Get.find<SchoolListController>().getSchoolListData(1,reload:reload).then((_){
schoolList=Get.find<SchoolListController>().schoolList;
  ...
  Get.find<StudentController>().getStudentList(reload, isUpdate: reload,id:id);
  Get.find<SchoolRequirementController>().getSchoolRequirementList(reload, schoolId: 1, classId: 1, studentId: 322);
...
Get.find<EduboxMaterialController>().getEduboxMaterialList(false, schoolId: 0, classId: 0, studentId: 300);
}
            ...
            fontSize:screenHeight>=763? Dimensions.fontSizeExtraLarge:Dimensions.fontSizeDefault, color: Colors.white,
                          ...
                          SizedBox(height:  screenHeight>=763?10:3),
                            SizedBox(
                              ...
                              width: screenHeight>=763?215:100,
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                           SizedBox(
                                  height:screenHeight>=763?101:51
                                 ),
                    Center(
                      child: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text('Itangazo:',style:Theme.of(context).textTheme.bodyMedium!.copyWith(fontWeight: FontWeight.bold)),
                          InkWell(
                            onTap:(){},
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 8.0,vertical: 3.0),
                              child: Text('More',style:Theme.of(context).textTheme.bodyMedium!.copyWith(fontWeight: FontWeight.w500,color: kTextLightColor,fontSize: 12)),
                            ),
                          ),
                          ],
                        ),
          ...
          children: [
            Column(
                ...
                Column(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                      screenHeight>=763?  sizedBox:const SizedBox(height:10),
                                              SizedBox(
              ...
              BorderButton1(
                        ...
                        height: 30,
                        width: screenWidth>=520? 148:screenWidth/2.5,
                        icon: 'Ababyeyi',
                    ...
                    BorderButton1(
                        ...
                        onPress: ()=>_launchURL('https://supply.hosomobile.rw/'),
                        height: 30,
                        width: screenWidth>=520? 148:screenWidth/2.5,
                        icon: 'Amashuli',
...
class _HomeCard2State extends State<HomeCard2> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.bannerList.isEmpty) {
      return const Center(child: CircularProgressIndicator()); // Show loading spinner if data is not available
    }
    ...
    return Padding(
      ...
      child: ClipRRect(
        ...
        child: CarouselSlider.builder(
          ...
          itemCount:widget.bannerList.length, // Use the length of the banner list
          itemBuilder: (BuildContext context, int index, int pageViewIndex) {

            final bannerImage = '$appBase$imageUri${widget.bannerList[index].image}'; // Assuming `imageUrl` is the field in BannerModel that holds the image URL
