...
import 'package:hosomobile/features/home/screens/upgrades/home/studentpoto_screen/components/shikabamba/widget/sr_categories.dart';
...
class SrMentorRead extends StatelessWidget {
  const SrMentorRead({super.key});
  static const String routeName = 'SrMentorRead';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('SrMentor read'),
                                ...
                                Row(
                                  ...
                                  children: [
                                    HomeCard3(
                                        onPress: () {
                                          Navigator.pushNamed(
                                              context, SrCategories.routeName);
                                        },
                                        icon:
