...
class PaymentMethodSl extends StatefulWidget {
  static String routeName = 'PaymentMethodSl';
  PaymentMethodSl(
      {super.key,
...
class _PaymentMethodState extends State<PaymentMethodSl> {
...
class HomeCard1 extends StatefulWidget {
  ...
  final List<SchoolLists> material;
  final String schoolName;
  final String studentCode;
  final String className;
  final String amount;
