...
import 'package:hosomobile/helper/tween_helper.dart';
import 'package:hosomobile/common/widgets/hero_dialogue_route_widget.dart';
import 'package:hosomobile/features/home/widgets/user_name_widget.dart';
import 'package:hosomobile/features/transaction_money/screens/transaction_balance_input_screen.dart';
import 'package:hosomobile/features/home/widgets/animated_button_widget.dart';
                  ...
                  GetBuilder<SplashController>(builder: (splashController) {
                    ...
                    return isRequestMoney
                        ? AnimatedButtonWidget(
                            onTap: () => Get.to(
                                () => const TransactionBalanceInputScreen(
                                      transactionType:
                  ...
                  GestureDetector(
                    onTap: () => Navigator.of(context).push(
                        HeroDialogRouteWidget(
                            builder: (_) => const _QrPopupCardWidget())),
                    child: Hero(
                      tag: Get.find<HomeController>().heroShowQr,
                      createRectTween: (begin, end) =>
                          TweenHelper(begin: begin, end: end),
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: Theme.of(context)
                              .cardColor
                              .withOpacity(Get.isDarkMode ? 0.7 : 1),
                        ),
                        child: profileController.userInfo != null
                            ? SvgPicture.string(
...
class _QrPopupCardWidget extends StatelessWidget {
  const _QrPopupCardWidget({super.key});
