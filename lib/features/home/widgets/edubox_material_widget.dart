...
class EduboxMaterialWidget extends StatelessWidget {
  const EduboxMaterialWidget({super.key});
                    ...
                    return CustomInkWellWidget(
                      ...
                      child: Container(width: 100,
                        ...
                        child: Column(
                          children: [
                          Text(
                              "${websiteLinkController.eduboxMaterialList![2].productTypes![index].price!}/${websiteLinkController.eduboxMaterialList![index].productTypes![index].price}",
                            ...
                            Text(
                              websiteLinkController.eduboxMaterialList![2].productTypes![index].name!,
                              style: rubikRegular.copyWith(
                                fontSize: Dimensions.fontSizeSmall,
                                color: ColorResources.getWebsiteTextColor(),
                              ),
