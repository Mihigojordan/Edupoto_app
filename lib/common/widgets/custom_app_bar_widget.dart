...
class CustomAppbarWidget extends StatelessWidget implements PreferredSizeWidget {
  ...
  const CustomAppbarWidget({super.key, required this.title, this.onTap,this.isSkip = false, this.function, this.onlyTitle = false});
  @override
          ...
          child: Center(
            child: Row(
              ...
              children: [
                ...
                Text(title, style: rubikMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Colors.black),
                ),
