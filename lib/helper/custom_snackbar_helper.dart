...
void showCustomSnackBarHelper(String? message, {bool isError = true, bool isIcon = false, bool isVpn = false, Duration? duration,bool isReload = false}) {
  if(isVpn) {
    SmartDialog.show(
      onDismiss: () async {
      ...
      builder: (_) {
        return Container(
          ...
          child: SafeArea(child: Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('Please Refresh'.tr, style: rubikLight.copyWith(color: Colors.white),),

                IconButton(
                  icon: const Icon(Icons.replay_outlined,size: 25),
                  color: Colors.white,
                  onPressed: () {
